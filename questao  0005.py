...
de uma pessoa. Depois faça uma função chamada peso que receba a altura e o sexo via parâmetro e que 
calcule e retorne o seu peso ideal, utilizando as seguintes fórmulas:
...
while True:
  try:
     ...
     if sexo =='M':
       ...
       print("\n Dados inválidos! Digite novamnete!")
